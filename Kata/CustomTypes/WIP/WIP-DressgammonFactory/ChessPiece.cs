...
{
    public class ChessPiece : PieceBase, ITakeable<ChessPiece>
    {
        ...
        public TakeResult<ChessPiece> TakePiece(bool overridePrevention = false)
        {
            throw new NotImplementedException();
        }

        public TakeResult<ChessPiece> TakePrevented()
        {
            throw new NotImplementedException();
        }
